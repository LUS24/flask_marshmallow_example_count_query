...
class UserRegister(Resource):
    ...
    def post(cls):
        ...
        # user = UserModel(**user_data) # Ya no se necesita por lo explicado arriba
        user.save_to_db()
...
class UserLogin(Resource):
    ...
    def post(cls):
        ...
        # Con @app.errorhandler(ValidationError)
        # try:
        #     # user_data pasa a ser un modelo debido a Flask-Marshmallow
        #     # aunque no es un modelo del objeto de la base de datos, representa
        #     # algo que fue enviado por el usuario.
